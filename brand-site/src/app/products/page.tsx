...
const products = [
  ...
  { id: 'skills-api', name: 'Agent Skills API', category: '外贸核心', price: '按需·API调用', desc: '4个独立AI能力' },
  ...
  { id: 'compliance-mw', name: '合规中间件', category: '合规安全', price: '¥20-80万/年', desc: 'FDA 510(k)等监管合规' },
